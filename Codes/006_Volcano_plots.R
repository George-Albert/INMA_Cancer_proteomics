...
deg_0.2_files <- list.files(file.path(input_dir,"003_DEG"),pattern = "mean_gt_0.2")
deg_0.5_files <- list.files(file.path(input_dir,"003_DEG"),pattern = "mean_gt_0.5")
deg_1_files <- list.files(file.path(input_dir,"003_DEG"),pattern = "mean_gt_1")
