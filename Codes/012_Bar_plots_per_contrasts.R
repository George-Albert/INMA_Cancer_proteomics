...
for (i in seq_along(vec)) {
  ...
  rownames(num_rows_list) <- gsub("_mean_gt_1","",rownames(num_rows_list))
  rownames(num_rows_list) <- gsub("_mean_gt_0.5","",rownames(num_rows_list))
  rownames(num_rows_list) <- gsub("_mean_gt_0.2","",rownames(num_rows_list))
